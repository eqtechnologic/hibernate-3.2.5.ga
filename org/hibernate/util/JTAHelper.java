...
public final class JTAHelper {
	...
	public static boolean isTransactionInProgress(jakarta.transaction.Transaction tx) throws SystemException {
	...
	public static boolean isMarkedForRollback(jakarta.transaction.Transaction tx) throws SystemException {
